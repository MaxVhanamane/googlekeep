...
export default function EditNote(props) {
    ...
    function handleUpdateNote(e) {
        ...
        if (editNoteState.etitle.length !== 0 || editNoteState.edescription.length !== 0) {
            updateNote(editNoteState.id, editNoteState.etitle, editNoteState.edescription, editNoteState.etag)
    ...
    return (<>
        ...
        <button type="button" ref={props.refValToOpenModal} className="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#editModal">
            Launch demo modal
        </button>

        {/* <!-- Modal --> */}
        <div className="modal fade mtforModal" id="editModal" tabIndex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <form action="">
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" id="etitle" name="etitle" placeholder="Enter your title" onChange={handleChange} value={editNoteState.etitle} />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="edescription" className="form-label">Description</label>
                                <textarea className="form-control" id="edescription" name="edescription" rows="3" onChange={handleChange} value={editNoteState.edescription}></textarea>
                            </div>
                            <div className="mb-3">
                                <label htmlFor="etag" className="form-label">Tag</label>
                                <input type="text" className="form-control" id="etag" name="etag" placeholder="Enter tag eg. general,office,etc" onChange={handleChange} value={editNoteState.etag} />
                            </div>
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-warning" onClick={handleUpdateNote}>Update Note</button>
                    </div>
                </div>
            </div>
        </div>
